            ...
            <div className="container">
                ...
                <div className="row justify-content-center">
                    <Members
                        name={"Jessica"}
                        title={"Bridesmaid"}
                        img={"./images/Jessica-and-Ash.jpg"}
                ...
                <div className="row justify-content-center">
                    <Members
                        name={"Jeremy"}
                        title={"Groomsman"}
                        img={"./images/Jeremy-and-Sean.jpg"}
