            ...
            <div className="container">
                ...
                <div className="row">
                    <p className="col-md-8 mx-auto">
                        ...
                        but we are confident and have our fingers and toes crossed that all restrictions
                        will be lifted in time for our wedding!!
                    </p>
                </div>
                <br></br>
                ...
                <div className="row">
                    <p className="col-md-8 mx-auto">
                        ...
                        but if you have any questions, please reach out to us: CookerlyMelody@gmail.com
                    </p>
                </div>
                <br></br>
                ...
                <div className="row">
                    <p className="col-md-8 mx-auto">
                        ...
                        due to our strict limit on how many people we can have. However, we recognize that some of you
                        will be traveling with your kids, so please know they are welcome at the Sunday beach party!
                    </p>
                </div>
                <br></br>
                ...
                <div className="row">
                    <p className="col-md-8 mx-auto">
                        ...
                        but be aware that it could get a little chilly at the wedding under the Redwood trees.
                    </p>
                </div>
                <br></br>
                ...
                <div className="row">
                    <p className="col-md-8 mx-auto">
                        ...
                        or you can park on the street, though be aware of the San Francisco hills.
                    </p>
                </div>
                <br></br>
                ...
                <div className="row">
                    <p className="col-md-8 mx-auto">
                        ...
                        Though we will have dancing inside
                    </p>
                    <br></br>
                </div>
                ...
                <div className="row">
                    <p className="col-md-8 mx-auto">
                        ...
                        grassy/dirt areas that you have to walk in so we ask that you wear chunky heels or sandals.
                        Also we want everyone's feet to be comfortable
                    </p>
                </div>
                <br></br>
